...
date: "Compiled `r doc_date()`;  Modified 20 June 2017"
package: "`r pkg_ver('Rhtslib')`"
abstract: >
  This package provides version 1.1 of the 'HTSlib' C library for
...
path is determined by `system.file("lib", package="Rhtslib")`. The
